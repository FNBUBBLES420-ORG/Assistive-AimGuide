...
# Поддержка AMD GPU [нажмите здесь](https://github.com/FNBUBBLES420-ORG/Assistive-AimGuide/blob/main/main_amd_scripts/dist/readme.md)
...
- Убедитесь, что **Node.js** установлен на вашей системе. Вы можете скачать его здесь: [Node.js v22.12.0 (Windows 64-bit)](https://nodejs.org/dist/v22.12.0/node-v22.12.0-x64.msi).
